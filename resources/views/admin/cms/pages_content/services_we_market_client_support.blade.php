        ...
        <div class="row no-margin">
            <div class="col-md-12 no-pad">
                <section class="content-header">
                    <h1>Service - We Market Client Support
                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row ">
                                      ...
                                      <form action="{{route('we.market.client.support.service.store')}}" class="form-validate is-alter"  method="POST" id="system_users_form" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-8 no-pad">
                                            ...
                                            {{-- <div class="col-md-12 form-group">
                                                ...
                                                <textarea class="form-control summernote" name="product_description" id="product_description"></textarea>
                                            </div> --}}
                                             <div class="col-md-12 form-group">
                                                <label>Description<span style="color: red;">*</span></label>

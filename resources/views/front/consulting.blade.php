...
<section class="pt-0">
    <div class="iq-blog-section service-view">
        <div class="service-view-img">
            <img src="{{!empty($service->banner_image_path)?url('/').Storage::url($service->banner_image_path):''}}" class="img-fluid w-100 service-view-img" alt="Forbes">
...
<script type="text/javascript">
    ...
    $(".consulting_active").addClass("active");
</script>

                    ...
                    <div class="col-sm-12">
                        <nav aria-label="breadcrumb" class="text-center iq-breadcrumb-two">
                            ...
                            <ol class="breadcrumb main-bg">
                                ...
                                <li class="breadcrumb-item active">{{!empty($service->banner_heading)?$service->banner_heading:''}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<section class="pt-0">
    <div class="iq-blog-section service-view">
        <div class="service-view-img">
            <img src="{{!empty($service->banner_image_path) && Storage::exists($service->banner_image_path) ? url('/').Storage::url($service->banner_image_path):''}}" class="img-fluid w-100 service-view-img" alt="Forbes">
        </div>
        <div class="container">

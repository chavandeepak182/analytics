...
@if(isset($category_details) && !empty($category_details))
    ...
    @section('meta_description',!empty($category_details->meta_keyword) ? $category_details->meta_keyword : '')
    @section('meta_keywords', !empty($category_details->meta_description) ? $category_details->meta_description : '')
@else

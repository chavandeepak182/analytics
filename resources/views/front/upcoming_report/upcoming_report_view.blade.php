                    ...
                    <div class="col-sm-12">
                        <nav aria-label="breadcrumb" class="text-center iq-breadcrumb-two">
                            ...
                            <ol class="breadcrumb main-bg">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('/upcomingreports')}}">Upcoming Reports</a></li>
        ...
        <div class="row">
                ...
                <div class="report-tabs mb-4 wow fadeInLeft">
                    <div class="iq-tabs">
                        <ul class="nav nav-pills sticky-top" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('*toc/*') || Request::is('*research-methodology/*') || Request::is('*infographics/*') || Request::is('*request-free-sample-pdf/*') ? '' : 'active show' }}" href="{{ url('upcomingreports/'.$report_details->url.'/'.$report_details->id) }}" role="tab">
                                    <h6 class="tab-title">Description</h6>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{Request::is('*toc/*') ? 'active' : ''}}" href="{{ url('upcomingreports/toc/'.$report_details->url.'/'.$report_details->id) }}" role="tab">
                                    <h6 class="tab-title"> Table Of Contents </h6>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{Request::is('*research-methodology/*') ? 'active' : ''}}" href="{{ url('upcomingreports/research-methodology/'.$report_details->url.'/'.$report_details->id) }}" role="tab">
                                    <h6 class="tab-title">Research Methodology</h6>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{Request::is('*infographics/*') ? 'active' : ''}}" href="{{ url('upcomingreports/infographics/'.$report_details->url.'/'.$report_details->id) }}" role="tab">
                                    <h6 class="tab-title">Infographics</h6>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{Request::is('*request-free-sample-pdf/*') ? 'active' : ''}}" href="{{ url('upcomingreports/request-free-sample-pdf/'.$report_details->url.'/'.$report_details->id) }}" role="tab">
            ...
            <div class="col-lg-4" id="scrollable-div">
                <div class="div-for-tablet sticky-form">
                    <form action="" method="get" id="sample_request_form">
                        <div class="more-report-btns mb-4">
                            <div class="more-report-btns-forms">
                                <!-- <input type="hidden" id="report_id" name="report_id" value="{{ !empty($report_details->id) ? $report_details->id : '' }}">
                                <input type="hidden" id="request_slug" name="request_slug" value=""> -->
                                <button type="button" class="button wow fadeInRight" url="{{ !empty($report_details->url) ? $report_details->url : '' }}" report_id="{{  !empty($report_details->id) ? $report_details->id : ''  }}" request_slug="sample-request"> Sample Request </button>
                                <button type="button" class="button wow fadeInRight" url="{{ !empty($report_details->url) ? $report_details->url : '' }}" report_id="{{  !empty($report_details->id) ? $report_details->id : ''  }}" request_slug="customization"> Customized Requirement </button>
                                <button type="button" class="button wow fadeInRight" url="{{ !empty($report_details->url) ? $report_details->url : '' }}" report_id="{{  !empty($report_details->id) ? $report_details->id : ''  }}" request_slug="analyst"> Speak to Analyst </button>
                                <button type="button" class="button wow fadeInRight" url="{{ !empty($report_details->url) ? $report_details->url : '' }}" report_id="{{  !empty($report_details->id) ? $report_details->id : ''  }}" request_slug="discount">Check Discount</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="plans-detail mb-4  wow fadeInRight">
                        ...
                        <form action="" method="post" id="license_type_submit_form">
                            @csrf
...
<!-- Sample Request Form -->
<div class="modal fade report-form-modal" id="SampleRequestForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="report-modal-header">
                    <div class="report_form_title"></div>
                    <div class="modal-discount-div d-none" id="modal_discount_form">
                        <h6 class="modal-discount-div-title d-none">We found you Lucky you Availed 10% Discount !</h6>
                    </div>
                ...
                <div class="form">
                    <div class="report_form_card">
                        <?php if (!empty($_SESSION['status']) && $_SESSION['status'] == 'success') { ?>
                            <p style="color:green; font-size:15px;margin-bottom: 10px;text-align: center;"><?php echo $_SESSION['message'];
                                                                                                            unset($_SESSION['message']);
                                                                                                            unset($_SESSION['status']); ?></p>
                        <?php }
                        if (!empty($_SESSION['status']) && $_SESSION['status'] == 'error') { ?>
                            <p style="color:red; font-size:15px;margin-bottom: 10px;text-align: center;"><?php echo $_SESSION['message'];
                                                                                                            unset($_SESSION['message']);
                                                                                                            unset($_SESSION['status']); ?></p>
                        <?php } ?>
                        <form action="{{ url('/reports/enquiry') }}" method="post" id="sample_request_form">
                            @csrf
                            <input type="hidden" id="request_type" name="request_type" value="">
                            <input type="hidden" id="report_title" name="report_title" value="{{ !empty($report_details->title) ? $report_details->title : '' }}">
                            <div class="report_form_field">
                                <i aria-hidden="true" class="ion ion-ios-person"></i>
                                <input type="text" id="name" name="name" class="report_form_input-field" autocomplete="off" placeholder="Full Name">
                            </div>
                            <div class="report_form_field">
                                <i aria-hidden="true" class="ion ion-ios-email"></i>
                                <input type="mail" id="email" name="email" class="report_form_input-field" autocomplete="off" placeholder="Email">
                            </div>
                            <div class="report_form_field">
                                <i aria-hidden="true" class="ion ion-ios-telephone"></i>
                                <input type="text" id="mobile_number" name="mobile_number" class="report_form_input-field" autocomplete="off" placeholder="Phone No.">
                            </div>
                            <div class="report_form_field">
                                <i aria-hidden="true" class="ion ion-briefcase"></i>
                                <input type="text" id="company_name" name="company_name" class="report_form_input-field" autocomplete="off" placeholder="Company">
                            </div>
                            <div class="report_form_field form-msg-box">
                                <i aria-hidden="true" class="ion ion-document-text"></i>
                                <span class="wpcf7-form-control-wrap your-message"><textarea id="message" name="message" cols="46" rows="12" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Message"></textarea></span>
                            </div>

                            <fieldset class="report_form_field MainCaptchaDiv">
                                <span id="WrongCaptchaError" class="error"></span>
                                <span class="text-success" id="SuccessMessage" class="error"></span>
                                <div class="CaptchaDiv">
                                    <div class='CaptchaWrap'>
...
<script type="text/javascript">
    $(".more-report-btns .more-report-btns-forms button").each(function() {
        $(this).click(function() {
            var request_slug = $(this).attr('request_slug');
            var url = $(this).attr('url');
            var report_id = $(this).attr('report_id');
            var full_url = "{{ url('/') }}/" + request_slug + "/" + url + "/" + report_id;
            // $("#request_slug").val(request_slug);
            $("#sample_request_form").attr("action", full_url)
...
<script type="text/javascript">
    $("#license_type_button_1").click(function() {
        var license_type = $("#license_type_button_1").attr("value");
        var base_url = "{{ url('/purchase/'.$report_details->url.'/'.$report_details->id.'/?license=') }}" + license_type;
        $("#license_type_submit_form").attr("action", base_url);
        $("#license_type_submit_form").submit();
    })
...
<script type="text/javascript">
    $("#license_type_button_2").click(function() {

        var license_type = $("#license_type_button_2").attr("value");
        //alert(license_type);
        var base_url = "{{ url('/purchase/'.$report_details->url.'/'.$report_details->id.'/?license=') }}" + license_type;
        $("#license_type_submit_form").attr("action", base_url);
        $("#license_type_submit_form").submit();
...
<script type="text/javascript">
    $("#license_type_button_3").click(function() {
        var license_type = $("#license_type_button_3").attr("value");
        var base_url = "{{ url('/purchase/'.$report_details->url.'/'.$report_details->id.'/?license=') }}" + license_type;
        $("#license_type_submit_form").attr("action", base_url);
        $("#license_type_submit_form").submit();
    })
...
<script>
    ...
    console.log('scrollable_height : ', scrollable_height);
